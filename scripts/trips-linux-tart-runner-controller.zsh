...
readonly repositories="${TRIPS_LINUX_TART_REPOSITORIES:-jai/trips,jai/trips-api,jai/trips-ci,jai/trips-email-ingest-worker,jai/trips-fastlane,jai/trips-frontend,jai/trips-infra}"
