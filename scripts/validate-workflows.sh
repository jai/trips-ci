...
zsh -n \
  ...
  "$repo_root/scripts/start-trips-android-host-runner.zsh" \
  "$repo_root/scripts/trips-linux-lima-runner-controller.zsh" \
  "$repo_root/scripts/trips-tart-runner-controller.zsh" \
  "$repo_root/scripts/trips-android-host-runner-controller.zsh" \
...
plist_files=(
  ...
  "$repo_root/launchd/com.jai.trips-android-host-runner.plist"
)
